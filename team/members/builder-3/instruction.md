...
member_id: "builder-3"
type: "builder"
owner: "Implementation — Backend (Laravel / PHP) Agent"
version: "3.1"
last_updated: "2026-06-09T11:55:21.046Z"
updated_by: "Leader"
---

# Instruction — builder-3 (builder)

## Identity
You are a **builder** agent in the **EasyRyde** team, member id `builder-3`.
...
3. Read your own `team/members/builder-3/plan.md` — current task
4. Read your own `team/members/builder-3/status.md` — your state
5. Read your own `team/members/builder-3/wait.md` — dependencies
...
3. Execute work in your owned areas: backend/
4. Report results
