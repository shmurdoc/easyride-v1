...
# Instruction — debugger-1 (debugger)

## Identity
You are a **debugger** agent in the **EasyRyde** team, member id `debugger-1`.
...
3. Read your own `team/members/debugger-1/plan.md` — current task
4. Read your own `team/members/debugger-1/status.md` — your state
5. Read your own `team/members/debugger-1/wait.md` — dependencies
