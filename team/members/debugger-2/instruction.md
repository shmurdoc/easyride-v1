...
# Instruction — debugger-2 (debugger)

## Identity
You are a **debugger** agent in the **EasyRyde** team, member id `debugger-2`.
...
3. Read your own `team/members/debugger-2/plan.md` — current task
4. Read your own `team/members/debugger-2/status.md` — your state
5. Read your own `team/members/debugger-2/wait.md` — dependencies
