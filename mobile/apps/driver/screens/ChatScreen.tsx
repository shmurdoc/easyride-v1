...
import { COLORS, generateId } from '@easyryde/shared';
...
export default function ChatScreen({ route }: any) {
  ...
  const sendMessage = () => {
    ...
    setMessages((prev) => [...prev, {
      id: generateId(), rideId, senderId: user.id, receiverId,
...
const styles = StyleSheet.create({
  ...
  sendButton: { backgroundColor: '#10B981', borderRadius: 20, paddingHorizontal: 20, justifyContent: 'center', marginLeft: 8 },
